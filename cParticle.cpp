#include "/Users/super/Downloads/cgcourse-master/cgcourse-master/CG_Demo_VS2015/CG_Demo/CG_Demo/header/GL/cParticle.h"
#include <math.h>
Particle::Particle()
{
	alive = true;
...
void Particle::integrateVerlet(float dt) {
	float rho = 100.0f;
	float dist[3] = { labs(pos[0] - oldPos[0]), labs(pos[1] - oldPos[1]),labs(pos[2] - oldPos[2]) };
